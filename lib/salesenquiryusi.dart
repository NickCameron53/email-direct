...
class EnquiryUSI extends StatefulWidget {
  EnquiryUSI({Key key, this.title}) : super(key: key);
  final String title;
...
class _EnquiryState extends State<EnquiryUSI> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('Sales Enquiry Upper S.I.'),
          centerTitle: true,
